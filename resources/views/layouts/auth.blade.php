...
<div class="content">
    ...
    <form class="login-form" action="/login" method="post">
        ...
        <div class="form-group">
            ...
            <div class="input-icon{{ $errors->has('username') ? ' has-error' : '' }}">
                <i class="fa fa-user" style="{{ $errors->has('username') ? 'color: #ed6b75  ' : '' }}"></i>
...
<!-- END LOGIN -->
<!-- BEGIN COPYRIGHT -->
<div class="copyright"> {{ \Carbon\Carbon::now()->year  }} &copy; {{ config('app.name') }}. </div>
<!-- END COPYRIGHT -->
<!--[if lt IE 9]>
